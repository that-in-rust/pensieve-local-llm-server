...
- [ ] 1.7 Analyze ./xsv/Cargo.toml
  ...
  - **Lines**: 48
  - **Task ID**: 1.7
- [ ] 1.8 Analyze ./xsv/tests/test_sort.rs
  - **File**: `./xsv/tests/test_sort.rs`
  - **Type**: rs
  - **Lines**: 145
  - **Task ID**: 1.8
- [ ] 1.9 Analyze ./xsv/tests/test_table.rs
  - **File**: `./xsv/tests/test_table.rs`
  - **Type**: rs
  - **Lines**: 25
  - **Task ID**: 1.9
- [ ] 1.10 Analyze ./xsv/tests/test_fmt.rs
  - **File**: `./xsv/tests/test_fmt.rs`
  - **Type**: rs
  - **Lines**: 71
  - **Task ID**: 1.10
- [ ] 1.11 Analyze ./xsv/tests/test_reverse.rs
...
- [ ] 2. Task Group 2
  - Analyze direct_text files in this group
- [ ] 2.1 Analyze ./xsv/session.vim
  - **File**: `./xsv/session.vim`
  - **Type**: vim
  - **Lines**: 1
  - **Task ID**: 2.1
- [ ] 2.2 Analyze ./xsv/tests/test_index.rs
  - **File**: `./xsv/tests/test_index.rs`
  - **Type**: rs
  - **Lines**: 27
  - **Task ID**: 2.2
- [ ] 2.3 Analyze ./xsv/tests/test_join.rs
  - **File**: `./xsv/tests/test_join.rs`
  - **Type**: rs
  - **Lines**: 186
  - **Task ID**: 2.3
- [ ] 2.4 Analyze ./xsv/tests/test_select.rs
  - **File**: `./xsv/tests/test_select.rs`
  - **Type**: rs
  - **Lines**: 116
  - **Task ID**: 2.4
- [ ] 2.5 Analyze ./xsv/tests/test_count.rs
  - **File**: `./xsv/tests/test_count.rs`
  - **Type**: rs
  - **Lines**: 62
  - **Task ID**: 2.5
- [ ] 2.6 Analyze ./xsv/tests/workdir.rs
  - **File**: `./xsv/tests/workdir.rs`
  - **Type**: rs
  - **Lines**: 170
  - **Task ID**: 2.6
- [ ] 2.7 Analyze ./xsv/tests/test_cat.rs
...
- [ ] 2.8 Analyze ./xsv/tests/test_split.rs
  ...
  - **Lines**: 268
  - **Task ID**: 2.8
- [ ] 2.9 Analyze ./xsv/tests/test_flatten.rs
  - **File**: `./xsv/tests/test_flatten.rs`
  - **Type**: rs
  - **Lines**: 84
  - **Task ID**: 2.9
- [ ] 2.10 Analyze ./xsv/tests/test_headers.rs
  - **File**: `./xsv/tests/test_headers.rs`
  - **Type**: rs
  - **Lines**: 67
  - **Task ID**: 2.10
- [ ] 2.11 Analyze ./xsv/tests/test_fixlengths.rs
...
- [ ] 3. Task Group 3
  - Analyze direct_text files in this group
- [ ] 3.1 Analyze ./xsv/tests/tests.rs
  - **File**: `./xsv/tests/tests.rs`
  - **Type**: rs
  - **Lines**: 188
  - **Task ID**: 3.1
- [ ] 3.2 Analyze ./xsv/tests/test_partition.rs
  - **File**: `./xsv/tests/test_partition.rs`
  - **Type**: rs
  - **Lines**: 271
  - **Task ID**: 3.2
- [ ] 3.3 Analyze ./xsv/README.md (chunk 1/3)
  - **File**: `./xsv/README.md`
  - **Chunk**: 1/3 (lines 1-300)
  - **Type**: md
  - **Lines**: 395
  - **Task ID**: 3.3
- [ ] 3.4 Analyze ./xsv/README.md (chunk 2/3)
  - **File**: `./xsv/README.md`
  - **Chunk**: 2/3 (lines 251-395)
  - **Type**: md
  - **Lines**: 395
  - **Task ID**: 3.4
- [ ] 3.5 Analyze ./xsv/README.md (chunk 3/3)
  - **File**: `./xsv/README.md`
  - **Chunk**: 3/3 (lines 346-395)
  - **Type**: md
  - **Lines**: 395
  - **Task ID**: 3.5
- [ ] 3.6 Analyze ./xsv/tests/test_frequency.rs
  - **File**: `./xsv/tests/test_frequency.rs`
  - **Type**: rs
  - **Lines**: 262
  - **Task ID**: 3.6
- [ ] 3.7 Analyze ./xsv/COPYING
  - **File**: `./xsv/COPYING`
  - **Type**: 
  - **Lines**: 3
  - **Task ID**: 3.7
- [ ] 3.8 Analyze ./xsv/tests/test_stats.rs
  - **File**: `./xsv/tests/test_stats.rs`
  - **Type**: rs
  - **Lines**: 215
  - **Task ID**: 3.8
- [ ] 3.9 Analyze ./xsv/tests/test_search.rs
  - **File**: `./xsv/tests/test_search.rs`
  - **Type**: rs
  - **Lines**: 151
  - **Task ID**: 3.9
- [ ] 3.10 Analyze ./xsv/tests/test_slice.rs
...
- [ ] 4. Task Group 4
  - Analyze direct_text files in this group
- [ ] 4.1 Analyze ./xsv/Cargo.lock (chunk 1/3)
  - **File**: `./xsv/Cargo.lock`
  - **Chunk**: 1/3 (lines 1-300)
  - **Type**: lock
  - **Lines**: 515
  - **Task ID**: 4.1
- [ ] 4.2 Analyze ./xsv/Cargo.lock (chunk 2/3)
  - **File**: `./xsv/Cargo.lock`
  - **Chunk**: 2/3 (lines 251-515)
  - **Type**: lock
  - **Lines**: 515
  - **Task ID**: 4.2
- [ ] 4.3 Analyze ./xsv/Cargo.lock (chunk 3/3)
  - **File**: `./xsv/Cargo.lock`
  - **Chunk**: 3/3 (lines 466-515)
  - **Type**: lock
  - **Lines**: 515
  - **Task ID**: 4.3
- [ ] 4.4 Analyze ./xsv/LICENSE-MIT
  - **File**: `./xsv/LICENSE-MIT`
  - **Type**: 
  - **Lines**: 21
  - **Task ID**: 4.4
- [ ] 4.5 Analyze ./xsv/src/cmd/sort.rs
  - **File**: `./xsv/src/cmd/sort.rs`
  - **Type**: rs
  - **Lines**: 159
  - **Task ID**: 4.5
- [ ] 4.6 Analyze ./xsv/src/cmd/join.rs (chunk 1/3)
  - **File**: `./xsv/src/cmd/join.rs`
  - **Chunk**: 1/3 (lines 1-300)
  - **Type**: rs
  - **Lines**: 436
  - **Task ID**: 4.6
- [ ] 4.7 Analyze ./xsv/src/cmd/join.rs (chunk 2/3)
  - **File**: `./xsv/src/cmd/join.rs`
  - **Chunk**: 2/3 (lines 251-436)
  - **Type**: rs
  - **Lines**: 436
  - **Task ID**: 4.7
- [ ] 4.8 Analyze ./xsv/src/cmd/join.rs (chunk 3/3)
  - **File**: `./xsv/src/cmd/join.rs`
  - **Chunk**: 3/3 (lines 387-436)
  - **Type**: rs
  - **Lines**: 436
  - **Task ID**: 4.8
- [ ] 4.9 Analyze ./xsv/src/cmd/cat.rs
  - **File**: `./xsv/src/cmd/cat.rs`
  - **Type**: rs
  - **Lines**: 132
  - **Task ID**: 4.9
- [ ] 4.10 Analyze ./xsv/src/cmd/reverse.rs
