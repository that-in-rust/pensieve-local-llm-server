...
// Copy the essential parts from the extractor module for testing
...
// Implementation functions (copied from extractor.rs)
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("- ✓ HTML content extractor with basic tag removal");
